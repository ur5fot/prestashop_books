...
{block name='content'}
    <section id="main" class="main" itemscope itemtype="https://schema.org/Product">
        ...
        {block name='page_content_container'}
            <section id="content" class="page-content templates--catalog--product">
                {block name='page_content'}
                    <div class="wrapper-thumbnails-flags">
                    ...
                    <div class="product-actions">
                        ...
                        {block name='product_buy'}
                                ...
                                {/block}
                                <!-- дублировался блок социальных кнопок я просто за коментировал блок ---!>
                    ...
                    <div class="tabs">
                        <nav class="nav">
                            <ul>
                                <li class="active" data-content='product-information'>Описание</li>
                                {if $product.features}
                                    <li data-content='product-features'>
                        ...
                        <div class="content">
                            <section class="product-information active">
